...
function exp_IBARAPAINNERROAD_4rule0_eval_expression(context) {
    // highway = 'primary'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('highway')  == 'primary');
    } else {
        return (feature.get('highway')  == 'primary');
    }
}
...
function exp_IBARAPAINNERROAD_4rule1_eval_expression(context) {
    // highway = 'secondary'
...
function exp_IBARAPAINNERROAD_4rule2_eval_expression(context) {
    // highway = 'tertiary'
